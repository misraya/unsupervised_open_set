...
class OpenSetBDDDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return img_tensor, anns, img_aug_tensor, anns_aug
...
def myCollate(data):
    img_tensors, annss, img_tensor_augs, anns_augs = [], [], [], []
    for sample in data:
        img_tensors.append(sample[0])
        annss.append(sample[1])
        img_tensor_augs.append(sample[2])
        anns_augs.append(sample[3])
    return img_tensors, annss, img_tensor_augs, anns_augs
